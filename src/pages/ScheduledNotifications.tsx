  ...
  return (
    <Box sx={{ p: { xs: 2, md: 3 } }}>
      <PageHeader
        ...
        icon={
          <NotificationsActiveIcon sx={{ fontSize: 32, color: '#BE5953' }} />
        }
        action={
          <Tooltip title="Refresh">
            <IconButton onClick={fetchData} sx={{ color: '#BE5953' }}>
              <RefreshIcon />
            </IconButton>
          </Tooltip>
        }
                ...
                sx={{
                  ...
                  bgcolor:
                    filterStatus === status
                      ? alpha('#BE5953', 0.12)
                      : 'rgba(0,0,0,0.04)',
                  color: filterStatus === status ? '#BE5953' : 'text.secondary',
                  border:
                    filterStatus === status
                      ? '1px solid rgba(190,89,83,0.3)'
                      : '1px solid transparent',
                  '&:hover': { bgcolor: alpha('#BE5953', 0.08) },
                }}
              />
            ),
          )}
              ...
              sx={{
                ...
                bgcolor:
                  filterType === type
                    ? alpha('#BE5953', 0.12)
                    : 'rgba(0,0,0,0.04)',
                color: filterType === type ? '#BE5953' : 'text.secondary',
                border:
                  filterType === type
                    ? '1px solid rgba(190,89,83,0.3)'
                    : '1px solid transparent',
