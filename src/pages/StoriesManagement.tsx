              ...
              >
                <MenuItem value="all">
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                    <FilterIcon sx={{ fontSize: 18, color: '#BE5953' }} />
                    All Categories
                  </Box>
                </MenuItem>
            ...
            {searchTerm && (
              <Chip
                ...
                sx={{
                  ...
                  color: '#BE5953',
                  '& .MuiChip-deleteIcon': { color: '#BE5953' },
                }}
              />
            )}
            {statusFilter !== 'all' && (
            ...
            return (
              <Card
                ...
                sx={{
                  ...
                  '&:hover': {
                    boxShadow: '0 8px 32px rgba(190, 89, 83, 0.12)',
                  },
                }}
              >
            ...
            {editingCategoryId && selectedCategory && (
              <Box sx={{ pt: 2, borderTop: '1px solid rgba(190,89,83,0.12)' }}>
                ...
                >
                  ...
                  <Typography sx={{ fontSize: '0.78rem', color: '#5C524D' }}>
                    ...
                    {storiesToDelete.length > 0 &&
                      ` · −${storiesToDelete.length} to remove`}
                  </Typography>
                </Box>
                ...
                >
                  ...
                  >
                    <UploadIcon sx={{ color: '#BE5953', fontSize: '1.5rem' }} />
                  </Box>
                  <Typography
                    sx={{
                      fontWeight: 600,
