...
import type { MenuCategory, MenuItem, MeasurementType } from './types';
...
export const MenuItemsView: React.FC<Props> = ({
    ...
    >
      ...
      <Typography
        sx={{
          fontSize: '0.6875rem',
          fontWeight: 600,
          color: item.isAvailable ? '#00A32A' : '#787C82',
          whiteSpace: 'nowrap',
        }}
      >
  ...
  const priceDisplay = (item: MenuItem) => {
      ...
      return (
        <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.5 }}>
          {item.measurements.slice(0, 3).map((m, mIdx) => {
            const typeName = measurementTypes.find(
              (mt) => mt.id === m.measurementTypeId,
            )?.name;
            const label = typeName
              ? `${typeName}: $${Number(m.price).toFixed(2)}`
          ...
          {item.measurements.length > 3 && (
            <Chip
              label={`+${item.measurements.length - 3}`}
              size="small"
              sx={{
                fontSize: '0.6875rem',
                height: 20,
    ...
    return (
      <Typography fontWeight={700} fontSize="0.9375rem" color="#00A32A">
      ...
      >
        ...
        >
          ...
          <Chip
            ...
            size="small"
            sx={{ bgcolor: '#FCEEEE', color: '#D63638', fontSize: '0.75rem' }}
          />
        </Box>
        {/* View toggle */}
        <Box
          ...
          <Tooltip title="Grid view">
            <IconButton
              ...
              sx={{
                borderRadius: 0,
                px: 1,
                bgcolor: viewMode === 'grid' ? '#BE5953' : 'transparent',
                color: viewMode === 'grid' ? '#fff' : '#50575E',
                '&:hover': {
                  bgcolor: viewMode === 'grid' ? '#A84E48' : '#F6F7F7',
                },
              }}
            >
          ...
          <Tooltip title="Table view">
            <IconButton
              ...
              sx={{
                borderRadius: 0,
                px: 1,
                bgcolor: viewMode === 'table' ? '#BE5953' : 'transparent',
                color: viewMode === 'table' ? '#fff' : '#50575E',
                '&:hover': {
                  bgcolor: viewMode === 'table' ? '#A84E48' : '#F6F7F7',
                },
              }}
            >
                  ...
                  >
                    ...
                    <TableCell sx={{ py: 1 }}>
                      ...
                      {item.preparationTime && (
                        ...
                        >
                          <AccessTimeIcon
                            sx={{ fontSize: 12, color: '#787C82' }}
                          />
                          <Typography fontSize="0.7rem" color="#787C82">
                            {item.preparationTime} min
                          </Typography>
                        </Box>
                      )}
                      ...
                      >
                        ...
                        <Tooltip title="Edit">
                          <IconButton
                            ...
                            sx={{
                              color: '#BE5953',
                              '&:hover': { bgcolor: 'rgba(190,89,83,0.08)' },
                            }}
                          >
